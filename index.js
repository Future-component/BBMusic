 ...
 * BBMusic
 * 1.0.0
 * Copyright (c) 2018-08-23 14:00:13 Beth
 * 一款音乐插件
        ...
        <div class="audio-src">
          ...
          <div class="content-index clearfix js_clickbtn">
            <div class="sourse-img start-rotate">
              <img src="./assets/cover.jpg" alt="声波图" class="icont-rotate"/>
            ...
            <div class="audio-box clearfix">
              <div bindtap='clickAudio'>
                <img class="music-btn music-pause-btn" src="./assets/pause.png" />
                <img class='music-btn music-play-btn' src="./assets/play.png" />
              </div>
              <span class="start-time">00:00</span>
              <div class="time-bar">
                <img class="time-bar-img" src="./assets/max-shengbo.png" alt="声波图"/>
